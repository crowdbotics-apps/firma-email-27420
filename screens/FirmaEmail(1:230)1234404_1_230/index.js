  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_1_231}>
        <Text style={styles.Text_1_231}>DISEÑADORA GRÁFICA</Text>
      </View>
      <View style={styles.View_1_232}>
        <Text style={styles.Text_1_232}>Marisol Shanahan</Text>
      </View>
      <ImageBackground
        source={{
          uri:
      ...
      <View style={styles.View_1_234}>
        <Text style={styles.Text_1_234}>marisol.shanahan@prodinamica.ag</Text>
      </View>
      <View style={styles.View_1_235}>
        <Text style={styles.Text_1_235}>Capitán Sarmiento, Prov. Bs As</Text>
      </View>
      <View style={styles.View_1_236}>
        <Text style={styles.Text_1_236}>PRODINAMICA.AG</Text>
      </View>
      <View style={styles.View_1_237}>
        <Text style={styles.Text_1_237}>Tel: (+54) 9 3415 069098</Text>
      </View>
      <ImageBackground
        source={{
          uri:
      ...
      <View style={styles.View_1_274}>
        <Text style={styles.Text_1_274}>PRODINAMICA.AG</Text>
      </View>
      <View style={styles.View_1_275}>
        <Text style={styles.Text_1_275}>Tel: (+54) 9 3415 069098</Text>
      </View>
      <ImageBackground
        source={{
          uri:
